...
<div class="product-container template-products list clearfix{if $settings.Appearance.default_product_details_layout != "default_template"} long{/if} row-fluid fadein">
    ...
    <div class="span5 product_image_wrapper">
        <span class="cm-reload-{$obj_prefix}{$obj_id} image-reload mcs_span_img" id="list_image_update_{$obj_prefix}{$obj_id} image-wrapper">
...
{*Line  28: added class mcs_span_img																	*}
