    ...
    <div class="cm-tabs-content" id="tabs_content_{$html_id}">
        <div id="content_general_{$html_id}">
            <fieldset>
				...
				<div class="control-group">
                    <label class="control-label" for="elm_icon_{$html_id}">{__("icon")}:</label>
                    <div class="controls">
                        <input type="text" name="tab_data[icon]" value="{$tab_data.icon}" id="elm_icon_{$html_id}" class="input-text" size="18" />
                    </div>
                </div>
...
{******************************************** MCS changes ***********************************************}
{*Line 126: added line 126 to 131																		*}