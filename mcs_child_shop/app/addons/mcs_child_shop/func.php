...
/*TODO:get url from addon setting*/
				$tmp_name=fn_get_url_data("http://localhost/cscart_parent/images/".$icons[$pair_id]['relative_path']);
				if(empty($tmp_name)){
...
/*TODO:get url from addon setting*/								
				$tmp_name=fn_get_url_data("http://localhost/cscart_parent/images/".$detailed[$pair_id]['relative_path']);
				if(empty($tmp_name)){
					write_log('Error getting image '.$detailed[$pair_id]['relative_path'].' from parent');
					continue;
				}
