...
{/if}
{if $items}
    <div class="wrap-dropdown-multicolumns mcs-i-menu {if $block.properties.mcs_top_menu_responsive=='Y'}mcs-resp-menu{/if}">
        <ul class="dropdown-multicolumns clearfix">
        
        {hook name="blocks:mcs_i_menu_dropdown_top_menu"}
            ...
            {if $item1.$childs}
                ...
                <div class="dropdown-1column">
                        ...
                        <div class="col-1 firstcolumn lastcolumn">
                            ...
                            {hook name="blocks:mcs_i_menu_dropdown_2levels_elements"}
                ...
                {* Three levels. Full output *}
                    ...
                    <ul class="{$dropdown_class}{if $smarty.foreach.item1.index > 4 && $smarty.foreach.item1.last} drop-left{/if} ddown" id="{$unique_elm_id}">
                        {hook name="blocks:mcs_i_menu_dropdown_3levels_cols"}
                        ...
                        {foreach from=$item1.$childs item="item2" name="item2"}
                            <li class="col-1{if $smarty.foreach.item2.index % $cols == 0 || $smarty.foreach.item2.first} firstcolumn{elseif $smarty.foreach.item2.index % $cols == ($cols - 1) || $smarty.foreach.item2.last} lastcolumn{/if}">
                                ...
                                {if $item2.$childs}
                                <ul>
                                {hook name="blocks:mcs_i_menu_dropdown_3levels_col_elements"}
...
{if $block.properties.mcs_top_menu_hide_third_level=='Y'}
	{script src="js/addons/mcs_framework/mcs_i_menu/mcs_i_menu.js"}
{/if}
