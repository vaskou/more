{if $page.page_type == 'MCS'}
    ...
    {else}
<div class="clearfix">
<div class="float-left vs-page-form-content">
    {$page.description nofilter}
</div>
<div class="form-wrap form-wrap-default vs-page-form-form cm-notification-max-height">
    ...
    {hook name="pages:mcs_getaquote_products"}
    {/hook}
    
    {include file="common/image_verification.tpl" option="use_for_form_builder"}

    <div class="buttons-container">
        {include file="buttons/button.tpl" but_role="submit" but_text=__("submit") but_name="dispatch[pages.mcs_send_form]"}
    </div>
