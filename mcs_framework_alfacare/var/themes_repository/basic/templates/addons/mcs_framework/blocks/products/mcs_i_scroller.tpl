...
{if $items}
    ...
    {/if}
    {if $block.properties.hide_features == "Y"}
        {assign var="hide_features" value=true}
    {else}
        {assign var="hide_features" value=false}
    {/if}
    {if $block.properties.hide_rating == "Y"}
        {assign var="hide_rating" value=true}
    {else}
        {assign var="hide_rating" value=false}
    {/if}
    {if $block.properties.hide_points == "Y"}
        {assign var="hide_points" value=true}
    {else}
        {assign var="hide_points" value=false}
    {/if}
    {if $block.properties.hide_add_to_wish == "Y"}
        {assign var="hide_add_to_wish" value=true}
    {else}
        {assign var="hide_add_to_wish" value=false}
    {/if}
    {if $block.properties.hide_add_to_compare == "Y"}
        {assign var="hide_add_to_compare" value=true}
    {else}
        {assign var="hide_add_to_compare" value=false}
    {/if}
	{if $block.properties.enable_quick_view == "Y"}
    	{assign var="enable_quick_view" value=true}
    {else}
    	{assign var="enable_quick_view" value=false}
    {/if}
    ...
    {/if}
<div class="mcs_i_grid mcs_i_scroller">
    {include file="addons/mcs_framework/blocks/mcs_scroller_template/mcs_i_scroller.tpl" 
    products=$items 
