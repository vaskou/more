            ...
            <li class="product">
            	 {if $product}
                    ...
                    <div class="product-wrapper">
                        ...
                        {hook name="products:mcs_i_product_multicolumns_list"}
                        ...
                        <div class="product_extra_info">
                            {if $addons.mcs_framework.mcs_product_categories_features=='Y' && !$hide_features}
                            ...
                            {/if}
                            {if $addons.mcs_framework.mcs_product_categories_rating=='Y' && !$hide_rating}
                                <div class="mcs_rating">
                                    {assign var="rating" value="rating_$obj_id"}
                                    {$smarty.capture.$rating nofilter}
                                </div>
                            {/if}
                            {if $addons.mcs_framework.mcs_product_categories_points=='Y' && !$hide_points}
                        ...
                        <div class="product-meta">
                        	{if !$hide_add_to_wish || !$hide_add_to_compare || $enable_quick_view || $show_add_to_cart}
                            <div class="product-meta-wrapper">
                                ...
                                {if $addons.wishlist.status=='A' || $product.feature_comparison == "Y"}
                                    {$top_buttons='true'}
                                {/if}
                                	{if !$hide_add_to_wish || !$hide_add_to_compare}
                                    <div class="add-buttons-wrap {if $cart_button_exists || (($product.out_of_stock_actions == "S") && ($product.tracking != "O"))} no-margin{/if} {if $top_buttons=='false'} no_top_buttons{/if}">
                                        <div class="add-buttons-inner-wrap">
                                            {if $addons.wishlist.status=="A" && !$hide_add_to_wish}
                                            ...
                                            {/if}
                                            {if $product.feature_comparison == "Y" && !$hide_add_to_compare}
